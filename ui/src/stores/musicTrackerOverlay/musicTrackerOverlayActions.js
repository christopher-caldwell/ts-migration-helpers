...
export const errorRequestOverlay = error => ({ type: ERROR_REQUEST_OVERLAY, error });

export const successApproveOverlay = () => ({ type: SUCCESS_APPROVE_OVERLAY });

export const errorApproveOverlay = error => ({ type: ERROR_APPROVE_OVERLAY, error });

export const successCancelOverlay = () => ({ type: SUCCESS_CANCEL_OVERLAY });

export const errorCancelOverlay = error => ({ type: ERROR_CANCEL_OVERLAY, error });

export const closeOverlay = () => ({ type: CLOSE_OVERLAY });

export const openOverlay = showConfirm => ({ type: OPEN_OVERLAY, showConfirm });
