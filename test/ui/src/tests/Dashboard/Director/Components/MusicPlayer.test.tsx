...
// @ts-expect-error ts-migrate(2322) FIXME: Type '{ song: any; onSelectSong: any; }' is not as... Remove this comment to see the full error message
// @ts-expect-error ts-migrate(2322) FIXME: Type '{ song: any; onSelectSong: any; }' is not as... Remove this comment to see the full error message
// @ts-expect-error ts-migrate(7016) FIXME: Could not find a declaration file for module 'enzy... Remove this comment to see the full error message
// @ts-expect-error ts-migrate(2339) FIXME: Property 'onSelectSong' does not exist on type '{}... Remove this comment to see the full error message
